...
Page({
  ...
  data: {
    ruleIndex: '',
    rules:['4小时','5小时','6小时','7小时','8小时','9小时','10小时','11小时','12小时','13小时','14小时','15小时','16小时','17小时','18小时','19小时','20小时','21小时','22小时','23小时','24小时',],
    limitIndex:'',
    ...
    couponName: '',
    type: '',
    types: [{id:1,name:'抵扣券'},{id:2,name:'满减券'}],
    storeId: "", //门店
    tags: [],
    stores: [],
    roomType: '',
    rooms: [{id:null,name:'不限制'},{id:1,name:'小包'},{id:2,name:'中包'},{id:3,name:'大包'}],
    minUsePrice: '',
    price: '',
    expriceTime: '',
